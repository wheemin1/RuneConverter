        ...
        <CardContent className="p-6 md:p-8">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="bg-gradient-to-r from-parchment/50 to-transparent rounded-2xl p-5 md:p-6 border-l-4 border-viking-gold">
              <h4 className="font-bold text-lg md:text-xl text-viking-brown mb-3">룬 문자란?</h4>
            ...
            <div className="bg-gradient-to-r from-parchment/50 to-transparent rounded-2xl p-5 md:p-6 border-l-4 border-viking-gold">
              <h4 className="font-bold text-lg md:text-xl text-viking-brown mb-3">엘더 푸타르크 (Elder Futhark)</h4>
              <p className="text-sm md:text-base text-text-brown-light leading-relaxed md:leading-loose">
            ...
            <div className="bg-gradient-to-r from-parchment/50 to-transparent rounded-2xl p-5 md:p-6 border-l-4 border-viking-gold">
              <h4 className="font-bold text-lg md:text-xl text-viking-brown mb-3">룬 문자의 의미</h4>
              <p className="text-sm md:text-base text-text-brown-light leading-relaxed md:leading-loose">
