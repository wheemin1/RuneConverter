...
export const translations = {
  ko: {
    ...
    nativeName: '원어 이름',
    romanizedName: '로마자 표기 (수정 가능)',
    alphabetName: '알파벳 이름',
    koreanPlaceholder: '예: 조휘민, 김민수, 박지연...',
    englishPlaceholder: '예: jowheemin, kimminsu, parkjiyeon...',
    nativePlaceholder: '예: 田中, さくら, 张伟...',
    romanizedPlaceholder: '예: tanaka, sakura, zhangwei...',
    alphabetPlaceholder: '예: john, maria, ahmed...',
    convertButton: '룬 문자로 변환하기',
    convertingButton: '신비로운 변환 중...',
    tipText: '자동 변환된 영문 이름을 원하는 방식으로 수정할 수 있습니다. 발음이나 선호하는 영문 표기법에 맞게 조정해보세요.',
    tipLabel: '팁:',
    romanizedTipText: '자동 변환된 로마자 표기를 원하는 방식으로 수정할 수 있습니다.',
    alphabetTipText: '알파벳 이름을 입력하고 룬 문자로 변환해보세요.',
    englishRequiredTitle: '영문 이름 입력 필요',
    englishRequiredDesc: '룬 문자 변환을 위해 영문 이름을 입력해주세요.',
    englishInvalidTitle: '잘못된 영문 형식',
    englishInvalidDesc: '영문 이름은 알파벳으로만 입력해주세요.',
    ...
    cancel: '취소',
    saveFailed: '저장 실패',
    saveFailedDesc: '브라우저 저장 공간이 부족하거나 개인정보 보호 모드일 수 있습니다.',
    loadFailed: '불러오기 실패',
    loadFailedDesc: '저장된 결과를 불러올 수 없습니다.',
    copyRuneSuccess: '룬 정보 복사 완료',
    copyRuneSuccessDesc: '룬 문자 정보가 클립보드에 복사되었습니다.',
    ...
    shareTextTemplate: '{name}의 바이킹 룬 문자: {runes} - {url}',
  ...
  en: {
    ...
    nativePlaceholder: 'e.g., 田中, さくら, 张伟...',
    romanizedPlaceholder: 'e.g., tanaka, sakura, zhangwei...',
    alphabetPlaceholder: 'e.g., john, maria, ahmed...',
    ...
    tipLabel: 'Tip:',
    romanizedTipText: 'You can edit the auto-converted romanized name as you prefer.',
    alphabetTipText: 'Enter an alphabet name and convert it to runes.',
    englishRequiredTitle: 'English Name Required',
    englishRequiredDesc: 'Please enter an English name for rune conversion.',
    englishInvalidTitle: 'Invalid English Format',
    englishInvalidDesc: 'English name should contain only alphabetic characters.',
    ...
    saveFailedDesc: 'Storage quota exceeded or private browsing mode may be active.',
    loadFailed: 'Load Failed',
    loadFailedDesc: 'Unable to load saved results.',
    copyRuneSuccess: 'Rune Info Copied',
    copyRuneSuccessDesc: 'Rune information copied to clipboard.',
    ...
    shareTextTemplate: '{name}\'s Viking Runes: {runes} - {url}',
  ...
  ja: {
    ...
    nativeName: '母国語の名前',
    romanizedName: 'ローマ字表記（編集可能）',
    alphabetName: 'アルファベット名',
    koreanPlaceholder: '例：조휘민、김민수、박지연...',
    englishPlaceholder: '例：jowheemin、kimminsu、parkjiyeon...',
    nativePlaceholder: '例：田中、さくら、太郎...',
    romanizedPlaceholder: '例：tanaka、sakura、tarou...',
    alphabetPlaceholder: '例：john、maria、ahmed...',
    convertButton: 'ルーン文字に変換',
    convertingButton: '神秘的な変換中...',
    tipText: '自動変換された英語名を希望に合わせて修正できます。発音や好みの英語表記法に調整してください。',
    tipLabel: 'ヒント：',
    romanizedTipText: '自動変換されたローマ字表記をお好みに合わせて修正できます。',
    alphabetTipText: 'アルファベット名を入力してルーン文字に変換してください。',
    englishRequiredTitle: '英語名が必要です',
    englishRequiredDesc: 'ルーン文字変換のために英語名を入力してください。',
    englishInvalidTitle: '無効な英語形式',
    englishInvalidDesc: '英語名はアルファベットのみで入力してください。',    
    // Converting Page
    ...
    cancel: 'キャンセル',
    saveFailed: '保存失敗',
    saveFailedDesc: 'ストレージ容量が不足しているか、プライベートブラウジングモードの可能性があります。',
    loadFailed: '読み込み失敗',
    loadFailedDesc: '保存された結果を読み込めません。',
    copyRuneSuccess: 'ルーン情報コピー完了',
    copyRuneSuccessDesc: 'ルーン文字情報がクリップボードにコピーされました。',
    ...
    shareTextTemplate: '{name}のバイキングルーン文字: {runes} - {url}',
  ...
  zh: {
    ...
    nativeName: '母语姓名',
    romanizedName: '罗马字表示（可编辑）',
    alphabetName: '字母姓名',
    koreanPlaceholder: '例如：조휘민、김민수、박지연...',
    englishPlaceholder: '例如：jowheemin、kimminsu、parkjiyeon...',
    nativePlaceholder: '例如：张伟、李娜、王芳...',
    romanizedPlaceholder: '例如：zhangwei、lina、wangfang...',
    alphabetPlaceholder: '例如：john、maria、ahmed...',
    convertButton: '转换为符文',
    convertingButton: '神秘转换中...',
    tipText: '您可以修改自动转换的英文姓名。根据您的发音或首选的英文拼写法进行调整。',
    tipLabel: '提示：',
    romanizedTipText: '您可以根据喜好修改自动转换的罗马字表示。',
    alphabetTipText: '输入字母姓名并转换为符文。',
    englishRequiredTitle: '需要英文姓名',
    englishRequiredDesc: '请输入英文姓名以进行符文转换。',
    englishInvalidTitle: '无效的英文格式',
    englishInvalidDesc: '英文姓名应仅包含字母字符。',
    ...
    cancel: '取消',
    saveFailed: '保存失败',
    saveFailedDesc: '存储空间不足或可能处于隐私浏览模式。',
    loadFailed: '加载失败',
    loadFailedDesc: '无法加载已保存的结果。',
    copyRuneSuccess: '符文信息复制完成',
    copyRuneSuccessDesc: '符文信息已复制到剪贴板。',
    ...
    shareLinkTitle: '分享链接',
    shareTextTemplate: '{name}的维京符文: {runes} - {url}',
  ...
  es: {
    ...
    alphabetName: 'Nombre en Alfabeto',
    koreanPlaceholder: 'ej., 조휘민, 김민수, 박지연...',
    englishPlaceholder: 'ej., jowheemin, kimminsu, parkjiyeon...',
    nativePlaceholder: 'ej., Juan, María, José...',
    romanizedPlaceholder: 'ej., juan, maria, jose...',
    alphabetPlaceholder: 'ej., john, maria, ahmed...',
    ...
    tipLabel: 'Consejo:',
    romanizedTipText: 'Puedes editar el nombre romanizado convertido automáticamente según prefieras.',
    alphabetTipText: 'Ingresa un nombre en alfabeto y conviértelo en runas.',
    englishRequiredTitle: 'Nombre en Inglés Requerido',
    englishRequiredDesc: 'Por favor ingresa un nombre en inglés para la conversión a runas.',
    englishInvalidTitle: 'Formato de Inglés Inválido',
    englishInvalidDesc: 'El nombre en inglés debe contener solo caracteres alfabéticos.',
    ...
    // Local Storage Features
    saveLocal: 'Guardar en mi dispositivo',
    loadLocal: 'Cargar resultados guardados',
    savedSuccessfully: 'Resultado de conversión guardado',
    noSavedResults: 'No se encontraron resultados guardados',
    savedResults: 'Resultados guardados',
    deleteResult: 'Eliminar',
    confirmDelete: '¿Estás seguro de que quieres eliminar?',
    cancel: 'Cancelar',
    saveFailed: 'Error al Guardar',
    saveFailedDesc: 'Cuota de almacenamiento excedida o el modo de navegación privada puede estar activo.',
    loadFailed: 'Error al Cargar',
    loadFailedDesc: 'No se pueden cargar los resultados guardados.',
    copyRuneSuccess: 'Info de Runa Copiada',
    copyRuneSuccessDesc: 'Información de runa copiada al portapapeles.',
    ...
    shareTextTemplate: 'Runas Vikingas de {name}: {runes} - {url}',
  ...
  fr: {
    ...
    alphabetName: 'Nom en Alphabet',
    koreanPlaceholder: 'ex., 조휘민, 김민수, 박지연...',
    englishPlaceholder: 'ex., jowheemin, kimminsu, parkjiyeon...',
    nativePlaceholder: 'ex., Pierre, Marie, Étienne...',
    romanizedPlaceholder: 'ex., pierre, marie, etienne...',
    alphabetPlaceholder: 'ex., john, maria, ahmed...',
    ...
    tipLabel: 'Conseil :',
    romanizedTipText: 'Vous pouvez modifier le nom romanisé converti automatiquement comme vous préférez.',
    alphabetTipText: 'Entrez un nom en alphabet et convertissez-le en runes.',
    englishRequiredTitle: 'Nom Anglais Requis',
    englishRequiredDesc: 'Veuillez entrer un nom anglais pour la conversion en runes.',
    englishInvalidTitle: 'Format Anglais Invalide',
    englishInvalidDesc: 'Le nom anglais ne doit contenir que des caractères alphabétiques.',
    ...
    // Local Storage Features
    saveLocal: 'Enregistrer sur mon appareil',
    loadLocal: 'Charger les résultats sauvegardés',
    savedSuccessfully: 'Résultat de conversion sauvegardé',
    noSavedResults: 'Aucun résultat sauvegardé trouvé',
    savedResults: 'Résultats sauvegardés',
    deleteResult: 'Supprimer',
    confirmDelete: 'Êtes-vous sûr de vouloir supprimer ?',
    cancel: 'Annuler',
    saveFailed: 'Échec de la Sauvegarde',
    saveFailedDesc: 'Quota de stockage dépassé ou le mode navigation privée peut être actif.',
    loadFailed: 'Échec du Chargement',
    loadFailedDesc: 'Impossible de charger les résultats sauvegardés.',
    copyRuneSuccess: 'Info de Rune Copiée',
    copyRuneSuccessDesc: 'Information de rune copiée dans le presse-papiers.',
    ...
    shareTextTemplate: 'Runes Vikings de {name} : {runes} - {url}',
